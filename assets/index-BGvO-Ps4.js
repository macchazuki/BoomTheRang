(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const Wl="BoomTheRang";function $t(i,e,t){if(e>t)throw new RangeError("minimum must not be greater than maximum");return Math.min(t,Math.max(e,i))}function Xl(i,e=.1){return $t(Number.isFinite(i)?i:0,0,e)}function Mr(i){return JSON.parse(JSON.stringify(i))}class ql{constructor({mountElement:e,onStartGame:t,onOpenSettings:n}){this.mountElement=e,this.onStartGame=t,this.onOpenSettings=n,this.root=null}mount(){const e=document.createElement("section");return e.className="screen main-menu",e.innerHTML=`
...
`)+`
`+d);const b=A+m+a,E=A+d+o,w=Ro(s,s.VERTEX_SHADER,b),C=Ro(s,s.FRAGMENT_SHADER,E);s.attachShader(S,w),s.attachShader(S,C),t.index0AttributeName!==void 0?s.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function L(P){if(i.debug.checkShaderErrors){const k=s.getProgramInfoLog(S)||"",G=s.getShaderInfoLog(w)||"",X=s.getShaderInfoLog(C)||"",$=k.trim(),W=G.trim(),te=X.trim();let z=!0,re=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,S,w,C);else{const ce=Lo(s,w,"vertex"),Ee=Lo(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
